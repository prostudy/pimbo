...
|---------|------------------------|-------------|---------------|
| **Gobernanza** | Acta de Constitución, Registro de Decisiones, Plan de Cambios, Checklist Kick-off, Business Model Canvas | Fase de Inicio y autorización del proyecto | [Ver detalles](skills/gobernanza.md) |
...
**Genera**: Acta de Constitución del Proyecto, Registro de Decisiones, Plan de Gestión de Cambios, Criterios de Éxito, Lista de Verificación de Kick-off, Business Model Canvas.
